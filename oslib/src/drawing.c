...
//Peut �tre mis � 0 pour gagner de la place, mais ce n'est pas garanti que tout fonctionne (particuli�rement si le mode de texture n'est pas repeat).
...
//Dessine une tile de la texture s�lectionn�e. Eviter d'utiliser � l'ext�rieur.   - NOT USED ANYMORE
...
//    sceGuDepthBuffer((void*)0x110000, 512);		// Absolute address is not good here !
	...
	//Remplit l'image par d�faut (informations en lecture seule)
	...
	//Le buffer secondaire est identique, � un d�tail pr�s (le buffer)
